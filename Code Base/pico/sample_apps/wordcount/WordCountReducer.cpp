...
pico::EmitConfiguration WordCountReducer::getEmitConfiguration(const void * const keys,
                                                               const int * const numVals,
                                                               const int numKeys,
                                                               int & numKeysToProcess)
{
  ...
  return pico::EmitConfiguration::createGridConfiguration(numKeys * sizeof(int),
