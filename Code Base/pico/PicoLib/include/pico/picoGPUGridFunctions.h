#ifndef __PICO_PICOGPUGRIDFUNCTIONS_H__
#define __PICO_PICOGPUGRIDFUNCTIONS_H__
...
__device__ void picoGridEmitKeyValRegister(picoGPUConfig * const config, const int outputNumber, const Key & key, const Value & value)
{
}

template <typename Key, typename Value>
__device__ void picoGridEmitKeyValShared(picoGPUConfig * const config,
...
template <typename Key, typename Value>
__device__ void picoGridEmitKeyValGlobal(picoGPUConfig * const config, const int outputNumber, const Key * const keyDataForBlock, const Value * const valueDataForBlock)
{
  const int * begin;
  const int * end;
  int * output;
